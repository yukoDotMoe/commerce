    ...
    <div class="container">
        ...
        <div class="mt-3 mb-4">
            ...
            <div class="mb-4 text-secondary text-justify">
                <span style="color: rgb(242, 243, 248) !important;background-color:rgb(17,23,35);">
                    <p><span style="color: rgb(65, 65, 63); font-size: 11px;">Copyright © 2023 . All rights reserved</span></p><p><span style="color: rgb(65, 65, 63); font-size: 11px;"><br></span></p>
                </span>
            </div>
        </div>
        <div class="row">
...
<section class="py-lg-3 text-light footer-widget" style="background-color: #212129 !important;">
    ...
    <div class="d-lg-none bg-transparent">
        ...
        <div class="aiz-accordion-wrap bg-black">
            <div class="aiz-accordion-heading container bg-black">
                <button class="aiz-accordion fs-14 text-white bg-transparent">{{ translate('CONTACT INFO') }}</button>
            </div>
            <div class="aiz-accordion-panel bg-transparent" style="background-color: #212129 !important;">
                <div class="container">
                    <ul class="list-unstyled mt-3">
        ...
        <div class="aiz-accordion-wrap bg-black">
            <div class="aiz-accordion-heading container bg-black">
                <button class="aiz-accordion fs-14 text-white bg-transparent">{{ translate('BE A SELLER') }}</button>
            </div>
            <div class="aiz-accordion-panel bg-transparent" style="background-color: #212129 !important;">
                <div class="container">
                    <ul class="list-unstyled mt-3">
